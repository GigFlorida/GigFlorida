...
<p><a href="#blank-lines">Blank lines</a> between block-level elements are ignored,
...
<p>Each row consists of cells containing arbitrary text, in which <a href="#inline">inlines</a> are
...
<a href="#lists">Lists</a> are meta-containers for <a href="#list-items">list items</a>.</p>
...
<li>If any line is a <a href="#thematic-breaks">thematic break</a> then
...
<div class="column">
<pre><code class="language-html">&lt;p&gt;&lt;del&gt;Hi&lt;/del&gt;<span class="space"> </span>Hello,<span class="space"> </span>world!&lt;/p&gt;
</code></pre>
</div>
</div>
...
<li>
<p>Backtick <a href="#code-span">code spans</a>, <a href="#autolinks">autolinks</a>, and raw <a href="#html-tag">HTML tags</a> bind more tightly
